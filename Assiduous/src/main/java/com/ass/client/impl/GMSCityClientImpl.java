...
@Component
public class GMSCityClientImpl implements GMSCityClient {

	public static final String RESOURCE = "/cities/";
	...
	@Override
	public List<CityDto> get(String token) throws RuntimeException {
	...
	@Override
	public CityDto get(String token, Integer id) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			HttpEntity<String> http_entity = new HttpEntity<String>(headers);
			ResponseEntity<CityDto> response = RestClient.REST_CLIENT.exchange(
	...
	@Override
	public CityDto get(String token, String code) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			ResponseEntity<CityDto> response = RestClient.REST_CLIENT.exchange(
					...
					HttpMethod.GET, http_entity, CityDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public CityDto getByName(String token, String name) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<CityDto> getByState(String token, Integer id) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			ResponseEntity<String> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + GET + RestClient.SLASH + STATE + RestClient.SLASH + id,
	...
	@Override
	public CityDto save(String token, CityDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		...
		try {
			...
			ResponseEntity<CityDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + SAVE, HttpMethod.POST, http_entity, CityDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public CityDto update(String token, CityDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			HttpEntity<String> http_entity = new HttpEntity<String>(body, headers);
			ResponseEntity<CityDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + UPDATE, HttpMethod.PUT, http_entity, CityDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
