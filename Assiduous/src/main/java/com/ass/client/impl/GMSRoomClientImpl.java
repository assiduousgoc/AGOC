...
@Component
public class GMSRoomClientImpl implements GMSRoomClient {

	public static final String RESOURCE = "/rooms/";
	...
	@Override
	public List<RoomDto> get(String token) throws RuntimeException {
	...
	@Override
	public RoomDto get(String token, Integer id) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			HttpEntity<String> http_entity = new HttpEntity<String>(headers);
			ResponseEntity<RoomDto> response = RestClient.REST_CLIENT.exchange(
	...
	@Override
	public RoomDto get(String token, String code) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			ResponseEntity<RoomDto> response = RestClient.REST_CLIENT.exchange(
					...
					HttpMethod.GET, http_entity, RoomDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public RoomDto getByName(String token, String name) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
	...
	@Override
	public RoomDto save(String token, RoomDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		...
		try {
			...
			ResponseEntity<RoomDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + SAVE, HttpMethod.POST, http_entity, RoomDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public RoomDto update(String token, RoomDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			HttpEntity<String> http_entity = new HttpEntity<String>(body, headers);
			ResponseEntity<RoomDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + UPDATE, HttpMethod.PUT, http_entity, RoomDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
