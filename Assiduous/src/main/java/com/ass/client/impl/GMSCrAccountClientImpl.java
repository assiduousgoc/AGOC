...
public class GMSCrAccountClientImpl implements GMSCrAccountClient {
	...
	@Override
	public List<CrAccountDto> get(String token) throws RuntimeException {
	...
	@Override
	public CrAccountDto get(String token, Integer id) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			HttpEntity<String> http_entity = new HttpEntity<String>(headers);
			ResponseEntity<CrAccountDto> response = RestClient.REST_CLIENT.exchange(
	...
	@Override
	public CrAccountDto save(String token, CrAccountDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		...
		try {
			...
			ResponseEntity<CrAccountDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + SAVE, HttpMethod.POST, http_entity, CrAccountDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public CrAccountDto update(String token, CrAccountDto dto) throws RuntimeException {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		headers.add("Accept", MediaType.APPLICATION_JSON_VALUE);
		headers.add(RestClient.AUTH_TOKEN, token);
		try {
			...
			HttpEntity<String> http_entity = new HttpEntity<String>(body, headers);
			ResponseEntity<CrAccountDto> response = RestClient.REST_CLIENT.exchange(
					RestClient.BASE_PATH + RestClient.GMS + UPDATE, HttpMethod.PUT, http_entity, CrAccountDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public CrAccountDto getByName(String token, String name) throws RuntimeException {
		...
		try {
			...
			ResponseEntity<CrAccountDto> response = RestClient.REST_CLIENT.exchange(
					...
					HttpMethod.GET, http_entity, CrAccountDto.class);
			return response.getBody();
		} catch (Exception e) {
			e.printStackTrace();
		}
