package com.ass.retaurant.client.impl;
...
@Component
public class CommonUserClientImpl implements CommonUserClient {

	public static final String RESOURCE = "/tokens/";
	...
	public UserData login(UserLoginDto dto) throws RuntimeException {
		...
		try {
			...
			ResponseEntity<UserData> response = RestClient.REST_CLIENT.exchange(RestClient.BASE_PATH_AUTH + LOGIN,
					HttpMethod.POST, http_entity, UserData.class);
