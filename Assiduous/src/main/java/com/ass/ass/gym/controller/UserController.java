...
public class UserController {
	...
	public String customerList(Model model, HttpServletRequest req) {
		UserData user = (UserData) req.getSession().getAttribute("user");
		List<UsersDto> usersList = gym_user_client.get(user.getToken());
		model.addAttribute("usersList", usersList);
		System.out.println(""+usersList.size());
		/*for(UsersDto users:usersList) {
			System.out.println(" F Name :"+users.getLastName());
			System.out.println("Addresas :"+users.getAddressDto().getLine1());
		}*/
