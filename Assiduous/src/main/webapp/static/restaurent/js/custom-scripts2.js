...
$(function() {
 ...
 $(function() {
                ...
                $('#action_tbl2 input[type="checkbox"]').bind('click',function(e) {
                    var $this = $(this);
                    if($this.is(':checked'))
                ...
                function showActionsBox(){
                    ...
                    var BoxesChecked = $('#action_tbl2 input:checked').length;
                ...
                $('#actionsBox .box_action').bind('click',function(e){
                    var ids = '';
                    $('#action_tbl2 input:checked').each(function(e,i){
                        var $this = $(this);
