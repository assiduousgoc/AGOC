...
"sPaginationType": "full_numbers",
	...
	$(function() {
	$('#action_tbl,#action_tbl2,#action_tbl3,#action_tbl4,#action_tbl5,#action_tbl6,#action_tbl7').dataTable({   
	 "aoColumnDefs": [
...
$(function() {
 ...
 $(function() {
                 ...
                 */
                $('#action_tbl,#action_tbl2,#action_tbl3,#action_tbl4,#action_tbl5,#action_tbl6,#action_tbl7 input[type="checkbox"]').bind('click',function(e) {
                    var $this = $(this);
                    if($this.is(':checked'))
                ...
                function showActionsBox(){
                    ...
                    var BoxesChecked = $('#action_tbl,#action_tbl2,#action_tbl3,#action_tbl4,#action_tbl5,#action_tbl6,#action_tbl7 input:checked').length;
                ...
                $('#actionsBox .box_action').bind('click',function(e){
                    var ids = '';
                    $('#action_tbl,#action_tbl2,#action_tbl3,#action_tbl4,#action_tbl5,#action_tbl6,#action_tbl7 input:checked').each(function(e,i){
                        var $this = $(this);
