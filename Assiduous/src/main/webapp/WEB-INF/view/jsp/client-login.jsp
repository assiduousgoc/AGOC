...
<div id=body-content class=no-margin
	style="border-bottom: 4px solid #066fb2;">
	<div class=container>
		<div class=row>
			...
			<div class=col-md-6>
				...
				<form action="dashboard.htm" method="post">
					<div class=form_cub>
						<h2>Client Login</h2>
						<div class=form_my>
							<span>Service</span> <select name=quat_services id=lastname
								required=required onchange=showvalue(this.value)>
						...
						<div class=form_my id="name">
							<span>User Name</span> <input type=text name=quat_fullname
								required id=firstname value>
						</div>
						<div class=form_my id="emailtab">
							<span>Password</span> <input type=password name=password id=email
								required value>
						</div>
