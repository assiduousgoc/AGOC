...
%>
<!-- Header start -->
		<div class="header" style="border-bottom: 2px solid #ffff;">
            <div class="header-left">
                <a href="index.html" class="logo" style="color: #ffff;font-weight: bold;font-family: auto;font-size: 16px;">
                    <img src="${pageContext.request.contextPath}/static/hospital/assets/img/CompanyLogo.jpg" width="35" height="35" alt="" style="margin-top: -5px;"> &nbsp;Assiduous Hospital Management System
                </a>
            </div>
