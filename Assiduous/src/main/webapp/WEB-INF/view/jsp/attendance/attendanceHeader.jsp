...
<%
    ...
    {
        response.sendRedirect("/Assiduous");
    }
%>
<!-- Header start -->
		<div class="header" style="border-bottom: 3px solid #095a94;">
                <div class="header-left">
                    <a href="index.html" class="logo">
						<img src="${pageContext.request.contextPath}/static/attendance/assets/img/CompanyLogo.jpg" width="40" height="40" alt="" style="width: 50px;border-radius: 50%;height: 50px; margin-top: 5px;border: 5px solid #f79753;">
					</a>
                </div>
				<a id="toggle_btn" style="margin-top: 10px;" href="javascript:void(0);"><i class="la la-bars"></i></a>
                <div class="page-title-box pull-left">
					<h3>Assiduous Attendance Management System</h3>
                </div>
				...
				<ul class="nav navbar-nav navbar-right user-menu pull-right">
									...
									<li class="media notification-message">
										<a href="activities.html">
											<div class="media-left">
												<span class="avatar">
													<img alt="John Doe" src="${pageContext.request.contextPath}/static/attendance/assets/img/user.jpg" class="img-responsive img-circle">
												</span>
											</div>
					...
					<li class="dropdown">
						<a href="profile.html" class="dropdown-toggle user-link" data-toggle="dropdown" title="Admin">
							<span class="user-img"><img class="img-circle" src="${pageContext.request.contextPath}/static/attendance/assets/img/user.jpg" width="40" alt="Admin">
