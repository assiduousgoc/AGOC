		...
		<div class="grid_12 full_block">
				<div class="widget_wrap tabby">
					<div class="widget_top">
						...
						<div id="widget_tab">
							<ul>
								<li><a href="#tab1" class="active_tab"><span class="alert_notify pink">30</span>Offers</a></li>
					...
					<div class="widget_content">
						<div id="tab1">
							<div class="widget_top" style="text-align: end;">
								...
								<div class="btn_30_light">
									<a href="resOffer.htm" class="tipTop" original-title="Import Item"><span class="icon doc_excel_csv_co"></span></a>
									</div>
								<div class="btn_30_light">
						...
						<tr>
							...
							<td class="center">
								<span><a class="action-icons c-edit" href="#" title="Edit">Edit</a></span><span><a class="action-icons c-delete confirm_dialog  confirm_dialog" href="#" title="delete">Delete</a></span><span><a class="action-icons c-approve" href="#" title="Approve">Done</a></span>
							</td>
						</tr>
