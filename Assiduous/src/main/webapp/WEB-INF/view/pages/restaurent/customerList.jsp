						...
						<div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tr>
                                        ...
                                        <td><img width="28" height="28" src="${pageContext.request.contextPath}/static/hospital/assets/img/french-fries.jpg" class="rounded-circle"><h2  style="text-align: center;">Herry</h2></td>
                                        <td style="text-align: center;">Jk Road</td>
                                       <td style="text-align: center;">khj@gfail.com</td>
