										...
										<div class="form_input">
										 <div class="list_left">
											<div class="form_grid_12">
												<label>Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge_style b_pending"> OPEN </span> </label>
											</div><br>
											<div class="form_grid_12">
												<label>ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> 2 </span> </label>
											</div><br>
											<div class="form_grid_12">
												<label>Ref:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>  1601708400000-0-3329 </span> </label>
											</div><br>
											<div class="form_grid_12">
												<label>Trans DT:&nbsp;&nbsp;<span> 3/10/20 12:30:00 </span> </label>
											</div><br>
											<div class="form_grid_12">
												<label>Notes:
												<span> <textarea rows="" cols="" name="notes"></textarea> </span> </label>
											</div><br>
										 </div>
										 ...
										 <div class="form_grid_12">
											...
											<div class="form_grid_6">
														<input name="filed30" type="text" class="datepicker" value="" disabled="disabled"/>
													</div>
											...
											<div class="form_grid_6">
														<input name="discount" type="text" class="" value="" />
													</div>
