                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-center">
                                <h3></h3>
                                <span class="widget-title1">Attendance <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                     <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg1" style="margin-top: -18px;"><i class="fa fa-users" style="margin-top: 8px;"  aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-center">
                                <h3></h3>
                     ...
                     <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-center">
                                <h3></h3>
                                <span class="widget-title1">Coupons <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                     <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
				...
				<div class="row">
                            <div class="col-12 col-md-8 col-lg-8 col-xl-8">
                                <div class="card" style="border: 2px solid #090696">
									<div class="card-header">
										<h4 class="card-title d-inline-block">RECENT JOIN USERS </h4> <a href="patients.html" class="btn btn-primary float-right">View all</a>
									</div>
											...
											<table class="table m-b-0 new-patient-table">
												...
												<tbody>
													...
													<tr>
														...
														<td>30 June 2020</td>
														<td>789393819</td>
														<td><button class="btn btn-primary btn-primary-two float-right">Pending</button></td>
													</tr>
													<tr>
														<td>
															<img width="28" height="28" class="rounded-circle" src="assets/img/user.jpg"> 
															<h2>Multigrain Hot Cereal</h2>
														</td>
														<td>30 June 2020</td>
														<td>137893137</td>
														<td><button class="btn btn-primary btn-primary-three float-right">Success</button></td>
													</tr>
							...
							<div class="col-12 col-md-4 col-lg-4 col-xl-4">
									<div class="hospital-barchart">
										<h4 class="card-title d-inline-block">Gym Management</h4>
									</div>
									<div class="bar-chart">
										<div class="legend">
											<div class="item">
											...
											<div class="item">
												<div class="bar">
													...
													<div class="item-progress" data-percent="12" style="width: 76.3594px;">
														<span class="title">New Joining</span>
													</div>
												</div>
											</div>
											...
											<div class="item">
												<div class="bar">
													...
													<div class="item-progress" data-percent="71" style="width: 238.793px;">
														<span class="title">User With Trainer</span>
													</div>
												</div>
											</div>
											...
											<div class="item">
												<div class="bar">
													...
													<div class="item-progress" data-percent="82" style="width: 275.789px;">
														<span class="title">Without Trainer User</span>
													</div>
												</div>
											</div>
