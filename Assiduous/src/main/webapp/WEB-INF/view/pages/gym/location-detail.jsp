			...
			<div class="col-xl-12 col-md-12">
				<div class="ms-panel ms-panel-fh"
					...
					<div class="ms-panel-header"
						...
						<h6 style="font-weight: bold;">Location Detail</h6>
					</div>
					<div class="ms-panel-body"
						style="position: relative; padding: 1.5rem;">
						<form:form action="update-location.htm" method="post"
							commandName="location" modelAttribute="location"
							cssClass="needs-validation clearfix">
							<div class="form-row">
								<div class="col-md-6 mb-3">
									<label for="validationCustom22">Location Code</label>
								...
								<div class="col-md-6 mb-3">
									<label for="validationCustom24">Location Name </label>
									<div class="input-group">
