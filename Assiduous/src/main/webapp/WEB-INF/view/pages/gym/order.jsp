   ...
   <a href=""><i class="material-icons">home</i> Home</a>
               ...
               <div class="col-lg-12">
                    <div class="card-box" style="border-bottom: 3px solid darkorange;">
							<button type="button" class="btn btn-primary" style="border-radius: 0px !important;background-color: #090696;">Order List</button>
						...
						<div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tr>
                                        ...
                                        <td style="text-align: center;">Maheshwar</td>
                                       <td style="text-align: center;">
                                           New Town
                                        </td>
                                         <td style="text-align: center;"><span class="badge badge-primary">Pending</span></td>
                                         <td style="text-align: center;">10:05</td>
                                          <td style="text-align: center;">7 May 2015/10:05 </td>
