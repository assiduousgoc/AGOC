			...
			<div class="col-lg-12">
				<div class="card-box" style="border-bottom: 3px solid darkorange;">
					<button type="button" class="btn btn-primary"
						style="border-radius: 0px !important; background-color: #4a274f;">State</button>
			...
			<div class="col-xl-12 col-md-12">
				<div class="ms-panel ms-panel-fh"
					...
					<div class="ms-panel-header"
						...
						<h6 style="font-weight: bold;">Country Detail</h6>
					</div>
					<div class="ms-panel-body"
						style="position: relative; padding: 1.5rem;">
						<form:form action="update-state.htm" method="post"
							commandName="state" modelAttribute="state"
							...
							<div class="form-row">
								...
								<div class="col-md-6 mb-3">
									<label for="validationCustom25">Countries</label>
									<div class="input-group">
										<form:select path="countryDto.id" cssClass="form-control">
											<c:forEach items="${countries}" var="country">
												<c:if test="${country.id eq state.countryDto.id}">
													<option value="${country.id}" selected="selected">${country.name}</option>
												</c:if>
												<c:if test="${country.id ne state.countryDto.id}">
