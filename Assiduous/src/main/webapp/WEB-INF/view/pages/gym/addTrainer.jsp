   ...
   <div class="row">
                <div class="col-lg-12">
                    <div class="card-box" style="border-bottom: 3px solid darkorange;">
							<button type="button" class="btn btn-primary" style="border-radius: 0px !important;background-color: #4a274f;">Trainer</button>
              ...
              <form class="needs-validation clearfix" novalidate>
                <div class="form-row">
                 ...
                 <div class="col-md-1 mb-3">
                   <div class="input-group">
                       <a href="trainerList.htm"><button class="btn btn-secondary d-block" type="button" style="min-width: 118px;background-color: #960613;">Back</button></a> 
                    </div>
                  </div>
                  <div class="col-md-1 mb-3">
                   <div class="input-group">
