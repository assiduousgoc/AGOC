   ...
   <div class="row">
               <div class="col-lg-12">
                    <div class="card-box" style="border-bottom: 3px solid #4a274f;">
							<a href="createSchedule.htm"> <button type="button" class="btn btn-primary" style="border-radius: 0px !important;background-color: #4a274f;">Add Course Schedule</button></a>
						...
						<!--  <ul class="nav nav-tabs nav-custom " role="tablist">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tr>
                                        ...
                                        <td><h2  style="text-align: center;">Yoga</h2></td>
                                        <td style="text-align: center;">Jane Austin</td>
                                       <td style="text-align: center;">Room-A</td>
